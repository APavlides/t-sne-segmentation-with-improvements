...
def calculate_P(X):
    ...
    for i in tqdm(xrange(0, n, batch_size)):
...
# gymgroup data
X_train = pd.read_csv("~/exploration/segmentation/X_train.csv")
X_test = pd.read_csv("~/exploration/segmentation/X_test.csv")
y_test = pd.read_csv("~/exploration/segmentation/y_test.csv")
...
for epoch in range(nb_epoch):
    ...
    # train
    loss = 0
    for i in xrange(0, n - batch_size, batch_size):
